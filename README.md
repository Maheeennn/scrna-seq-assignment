...
T Cells: Identified via conserved markers (e.g., CD3D, CD3E).

B Cells: Identified via CD79A and MS4A1 expression.

Monocytes: Distinguished by LYZ and CD14 expression.

(Insert placeholder for UMAP_clustering_plot.png)
...
(Insert placeholder for dotplot_marker_genes.png)
